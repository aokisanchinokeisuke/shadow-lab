...
export default defineConfig({
  ...
  use:{baseURL:'http://127.0.0.1:5173',viewport:{width:1440,height:960},headless:true,launchOptions:{args:['--use-angle=swiftshader','--enable-webgl','--ignore-gpu-blocklist']}},
